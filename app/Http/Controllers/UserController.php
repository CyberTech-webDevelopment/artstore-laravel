...
//            dd($errors);
    ...
    public function delete_avatar()
    {
        ...
        if($del_avatar != null)
        {
            ...
            $user->avatar = null;
            $user->save();
            return redirect()->back()->with('modal_type_account','del_avatar');

        }
        else
        {
            return redirect()->back()->with('modal_type_account','del_avatar')->with('no_img','You are dont have avatar image');
