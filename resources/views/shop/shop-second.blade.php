@extends('layouts.app')
@section('style')
    <link rel="stylesheet" href="{{ asset('assets/css/shop/shop-second.css') }}" >
@endsection
@section('content')

	<section class="container-fluid container-mobile-menu">
       <div class="row">
       	  <div class=" baner" style="background: url({{ asset('assets/images/baners/baner-1.png') }})">
       	  	 <div class=" baner-container w-100">
	       	  	  <div class="h-50 bd-highlight mt-4">
	       	  	  	  <div class="ml-auto mr-auto user-avatar-div" style="background: url({{ asset('assets/images/users-image/1.png') }}); background-size: cover;
	       	  	  ...
	       	  	  <div class="d-flex justify-content-center mr-auto ml-auto starts-and-info">
                          ...
                          <div class="pr-2 pl-2 bg-white contact-seller text-strong text-center"><span class="pr-2"><img src="{{ asset('assets/icons/icon-letter.png') }}"></span>Contact <span class="hidden-span">Seller</span></div>
	       	  	  	 </div>
	       	  	  </div>
		    	...
		    	<div class="row d-flex flex-nowrap nowrap-cont justify-content-center pr-0 pl-4 mr-0 pt-3">
		   	  				...
		   	  				<div >
			   	  				...
			   	  				<div class="transparent-bg-div d-flex" >
			   	  					...
			   	  					<div class="pordz" style="background: url({{ asset('assets/images/andrijana1.png') }}); background-size: cover">
		   	  			...
		   	  			<div class="col-xl-2 col-lg-2 col-md-3 col-sm-5 col-xs-5 right-div-item">
		   	  				<div >
			   	  				<div class="transparent-bg-div d-flex" >
			   	  					<div class="pordz" style="background: url({{ asset('assets/images/andrijana2.png') }}); background-size: cover">
			   	  						<span class="mobile-favorites-heart"><img src="{{ asset('assets/icons/vector-heart-wh.png') }}"></span>
			   	  					</div>
		   	  			...
		   	  			<div class="col-xl-2 col-lg-2 col-md-3 col-sm-5 col-xs-5 right-div-item">
		   	  				<div >
			   	  				<div class="transparent-bg-div d-flex" >
			   	  					...
			   	  					<div class="pordz" style="background: url({{ asset('assets/images/andrijana3.png') }}); background-size: cover">
			   	  						<span class="mobile-favorites-heart"><img src="{{ asset('assets/icons/vector-heart-wh.png') }}"></span>
			   	  					</div>
			   	  				    <div class="icon-new-arrival">
			   	  						<img src="{{ asset('assets/icons/icon-new-arrival.png') }}">
		   	  			...
		   	  			<div class="col-xl-2 col-lg-2 col-md-3 col-sm-5 col-xs-5 right-div-item">
		   	  				<div >
			   	  				<div class="transparent-bg-div d-flex" >
			   	  					...
			   	  					<div class="pordz" style="background: url({{ asset('assets/images/andrijana4.png') }}); background-size: cover">
			   	  						<span class="mobile-favorites-heart"><img src="{{ asset('assets/icons/vector-heart-wh.png') }}"></span>
			   	  					</div>
			   	  				    <div class="icon-new-arrival">
			   	  						<img src="{{ asset('assets/icons/icon-new-arrival.png') }}">
		    	...
		    	<div class="scroll-cont">
		    	   <div class="row d-flex flex-nowrap nowrap-cont justify-content-center pr-0 pl-4 mr-0 pt-3">
		   	  				...
		   	  				<div >
			   	  				...
			   	  				<div class="transparent-bg-div d-flex" >
			   	  					<!-- <img src="images/andrijana1.png') }}" class="img-fluid ps-abs-image"> -->
			   	  					<div class="pordz" style="background: url({{ asset('assets/images/ho1.png') }}); background-size: cover">
			   	  						<span class="mobile-favorites-heart"><img src="{{ asset('assets/icons/vector-heart-wh.png') }}"></span>
			   	  					</div>
		   	  			...
		   	  			<div class="col-xl-4 col-lg-4 col-md-5 col-sm-10 col-xs-10 right-div-item">
		   	  				<div >
			   	  				<div class="transparent-bg-div d-flex" >
			   	  					<div class="pordz" style="background: url({{ asset('assets/images/ho2.png') }}); background-size: cover">
			   	  						<span class="mobile-favorites-heart"><img src="{{ asset('assets/icons/vector-heart-wh.png') }}"></span>
			   	  					</div>
			   	  					<!-- <img src="images/andrijana2.png') }}" class="ps-abs-image"> -->
			   	  				    <div class="icon-hot hot ">
		   	  			...
		   	  			<div class="col-xl-4 col-lg-4 col-md-5 col-sm-10 col-xs-10 right-div-item">
		   	  				<div >
			   	  				<div class="transparent-bg-div d-flex" >
			   	  					<!-- <img src="images/andrijana3.png') }}" class="ps-abs-image"> -->
			   	  					<div class="pordz" style="background: url({{ asset('assets/images/ho3.png') }}); background-size: cover">
			   	  						<span class="mobile-favorites-heart"><img src="{{ asset('assets/icons/vector-heart-wh.png') }}"></span>
			   	  					</div>
			   	  				    <div class="icon-hot hot ">
			   	  						<img src="{{ asset('assets/icons/hot.png') }}">
