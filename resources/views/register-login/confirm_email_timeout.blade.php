<button type="button" id="s12_time" class="close" data-toggle="modal" data-target="#timelimited_end" data-dismiss="modal" aria-label="Close">
    SI12
</button>
<div class="modal fade" id="timelimited_end" tabindex="-1" aria-labelledby="exampleModalLabel55" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="row">
                <div class="modal-body mt-4 mb-4 text-strong text-center" id="">
                    <p>@lang('auth.modal_confirm_time')</p>
