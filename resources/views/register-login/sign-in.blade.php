        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="text-center footer-div">
                    <span class="text-strong">{{ app()->getLocale()=='Don’t have an Account?' ? 'OR' : ( app()->getLocale()=='ru' ? 'Нет учетной записи?' : ( app()->getLocale()=='am' ? 'Գրանցված չէ՞ք' : 'Don’t have an Account?')) }}</span>
