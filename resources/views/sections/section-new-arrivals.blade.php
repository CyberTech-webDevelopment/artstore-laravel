        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12 right-div pr-0">
                <div class="w-100 d-flex sec-title bd-highlight">
                    ...
                    <div class="pr-0 pt-2 flex-grow-1 bd-highlight">
                        <hr width="100%" color='#6d4017'>
                    </div>
                </div>
                                ...
                                <div>
                                    <div>
                                        <div class="transparent-bg-div d-flex">
                                            ...
                                            <div class="pordz"
                                                 style='background: url("/storage/product/{{$elem->product_head_images()}}"); background-size: cover'></div>
                                            <div class="icon-new-arrival ">
                                                <img src="{{ asset('assets/icons/icon-new-arrival.png') }}">
                                            </div>
                                            <div
                                                class="row pl-0 pr-0 hover-icons d-flex align-items-center bd-highlight">
                                                <div
                                                    class="w-100 div-icons d-flex justify-content-center align-self-center bd-highlight">
                                                    <span class=""><img
                                                            src="{{ asset('assets/icons/vector-search-wh.png') }}"></span>
                                                    <span class="ml-3 "><img
                                                            src="{{ asset('assets/icons/vector-heart-wh.png') }}"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="description">
                                        <a href="{{ route('product',[ 'locale' => app()->getLocale(), 'slug' => $elem['slug_'. app()->getLocale()]]) }}"
                                           class="product_name_inhead"><p
                                                class="mb-0 mt-1">{{ str_cut($elem['name_'. app()->getLocale()],15) }}</p>
                                        </a>
