@if(isset($product) && count($product->product_options) > 0)
            ...
            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-10 text-center">
                ...
                <div class="d-flex text-center">
                    <div class="ml-auto d-flex mr-auto">
                        ...
                        <span class="pl-2 pr-2 quantity">{{ $option->quantity }}</span>
                        <div class="plus_p">+</div>
                        <input type="hidden" value="{{ $option->quantity }}" class="product_count">
                    </div>
                </div>
